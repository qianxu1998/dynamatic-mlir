...
// This function calculates the the valid start time of different buffers in the specified cfdfc
// with this information, we can determine the active time of the ready and valid signal
// of different buffers.
// All info will be stored in the corresponding buffer node
...
// *The update process shall be simplified
...
// This function will return steady state starting time for the selected node in the specified CFDFC
int mgGetNodeStartingPoint(SwitchingInfo &switchInfo, std::string &selNode, std::string &selMG);

// This function calculates the switching activities of all handshake channels in the dataflow graph
